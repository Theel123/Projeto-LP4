...
<body>
    ...
    <section id="contact-page" class="container">
        <div class="row-fluid">
            <div class="span8">
                <h4>Formulario para edição de Cliente</h4>
                <div class="status alert alert-success" style="display: none"></div>
                    <div class="row-fluid">
 
                     <form  id="formulario_cliente"name="formulario_cliente" method="post" action="editar_cliente.php" >
                    <div class="row-fluid">
                        <div class="span5">
                            <input type="hidden" name="id_cliente" value=<?php print $info['id_cliente'];?>>

                            <label><b> Nome: *</b></label>
                            <input type="text" class="input-block-level"  placeholder="Nome Cliente..."" id="nome_cliente" name="nome_cliente" value=<?php print $info['cliente_nome'];?> >
                                                        <label><b> RG: *</b></label>
                            <input type="text" class="input-block-level" placeholder="RG ..." id="rg" name="rg" value=<?php print $info['cliente_rg'];?>>
                              <label><b>CPF: *</b></label>
                            <input type="text" class="input-block-level" placeholder="CPF ..." id="cpf" name="cpf" value=<?php print $info['cliente_cpf'];?>>
                              <label><b>Email: *</b></label>
                            <input type="text" class="input-block-level" placeholder="Email ..." id="email" name="email" value=<?php print $info['cliente_email'];?>>
                              <label><b>Telefone: *</b></label>
                            <input type="text" class="input-block-level" placeholder="Telefone ..." id="telefone" name="telefone" value=<?php print $info['cliente_telefone'];?>>
                              <label>Celular: </label>
                            <input type="text" class="input-block-level" placeholder="Celular ..." id="celular" name="celular" value=<?php print $info['cliente_celular'];?>>
                            ...
                            <label>Numero: *</label>
                            <input type="text" class="input-block-level" placeholder="Numero..." id="numero" name="numero"value=<?php print $info['cliente_numero'];?>  >
                            <label>Complemento: *</label>
                            <input type="text" class="input-block-level" placeholder="Complemento..." id="complemento" name="complemento" value=<?php print $info['cliente_complemento'];?>>
                          
                             <label>Senha: *</label>
                            <input type="text" class="input-block-level" placeholder="Senha..." id="senha" name="senha"value=<?php print $info['senha'];?>>
                    ...
                    <br>
                    <button id="cadastrar_cliente" name="cadastrar_cliente" class="btn btn-primary btn-large pull-left" >Editar Cliente</button>
