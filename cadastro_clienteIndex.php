                    ...
                    <ul class="nav">
                        ...
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                                <li><a href="#">Cadastro Autor</a></li>
                                <li><a href="#">Cadastro Cliente</a></li>
                                <li><a href="#">Cadastro Editora</a></li>
                                <li><a href="#">Cadastro Livro</a></li>
            ...
            <div class="span8">
                ...
                <div class="status alert alert-success" style="display: none"></div>
                    <div class="row-fluid">
                         ...
                         <form  id="formulario_cliente"name="formulario_cliente" method="post" action="cadatro_clienteIndex.php" onsubmit="return valida_form_cliente();">
                    <div class="row-fluid">
                        <div class="span5">
