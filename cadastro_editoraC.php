...
<body>
    ...
    <section id="contact-page" class="container">
        <div class="row-fluid">
            <div class="span8">
                <h4>Formulario para cadastro de Editoras</h4>
                <div class="status alert alert-success" style="display: none"></div>
                    <div class="row-fluid">
                     
                         <form  name="formulario_editora" method="post" action="cadastro_editora.php" onsubmit="return valida_form_editoras();">
                    <div class="row-fluid">
                        <div class="span5">
                            <label>Nome  </label>
                            <input type="text" class="input-block-level"  placeholder="Nome Editora..."" id="nome_editora" name="nome_editora">
                            <label>CNPJ: </label>
                            <input type="text" class="input-block-level" placeholder="CNPJ ..." id="cnpj_editora" name="cnpj_editora">
                        </div>
                      
                    </div>
                    <br>
                    <button id="cadastrar_editora" name="cadastrar_editora" class="btn btn-primary btn-large pull-left" >Cadastrar Editora</button>
...
<br>
  ...
  <tbody>
<?php
$lista = $editora->getAll(); 

foreach ($lista as $item):
?> 
<tr>
     <td><?php print $item['id_editora']?> </td>
     <td><?php print $item['editora_nome']?></td>
     <td><?php print $item['editora_cnpj']?> </td>
     <td> 
            <a href="editar_editoraC.php?id_editora=<?php print $item['id_editora']; ?>">[EDITAR]</a>
            <a href="cadastro_editora.php?id_editora=<?php print $item['id_editora']; ?>">[DELETAR]</a>
    </td>
