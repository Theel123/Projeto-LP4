...
<body>
    ...
    <section id="contact-page" class="container">
        <div class="row-fluid">
            <div class="span8">
                <h4>Formulario para edição de Funcionario</h4>
                <div class="status alert alert-success" style="display: none"></div>
                    <div class="row-fluid">
                     
                         <form  name="formulario_funcionario" method="post" action="editar_funcionario.php">
                    <div class="row-fluid">
                        <div class="span5">
                        <input type="hidden" name="id_autor" value=<?php print $info['id_funcionario'];?>>

                            <label><b> Nome: *</b></label>
                            <input type="text" class="input-block-level"  placeholder="Nome Funcionario..."" id="nome_funcionario" name="nome_funcionario" value=<?php print $item['funcionario_nome']?>>
                            <label><b> RG: </b></label>
                            <input type="text" class="input-block-level" placeholder="RG ..." id="rg" name="rg" value=<?php print $item['funcionario_rg']?>>
                              <label><b>CPF: *</b></label>
                            <input type="text" class="input-block-level" placeholder="CPF ..." id="cpf" name="cpf" value=<?php print $item['funcionario_cpf']?>>
                            <label><b>Data de Nascimento: *</b></label>
                                <input id="dataNascimento" name="dataNascimento" type="date" value=<?php print $item['funcionario_date_nascimento']?>>
                              <label><b>Email: *</b></label>
                            <input type="text" class="input-block-level" placeholder="Email ..." id="email" name="email" value=<?php print $item['funcionario_email']?>>
                              <label><b>Telefone: *</b></label>
                            <input type="text" class="input-block-level" placeholder="Telefone ..." id="telefone" name="telefone" value=<?php print $item['funcionario_telefone']?>>
                              <label>Celular: </label>
                            <input type="text" class="input-block-level" placeholder="Celular ..." id="celular" name="celular" value=<?php print $item['funcionario_celular']?> >
                                     <label>Cargo: *</label>
                            <input type="text" class="input-block-level" placeholder="Numero..." id="cargo" name="cargo" value=<?php print $item['funcionario_cargo']?>>
                            ...
                            <label>Numero: *</label>
                            <input type="text" class="input-block-level" placeholder="Numero..." id="numero" name="numero" value=<?php print $item['funcionario_numero']?>>
                            <label>Complemento: *</label>
                            <input type="text" class="input-block-level" placeholder="Complemento..." id="complemento" name="complemento" value=<?php print $item['funcionario_complemento']?>>
                    ...
                    <br>
                    <button id="editar_funcionario" name="editar_funcionario" class="btn btn-primary btn-large pull-left" >Cadastrar Funcionario</button>
