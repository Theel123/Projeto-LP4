...
<body>
    ...
    <section id="contact-page" class="container">
        <div class="row-fluid">
            <div class="span8">
                <h4>Formulario para cadastro de Autores</h4>
                <div class="status alert alert-success" style="display: none"></div>
                    <div class="row-fluid">

                         <form id="formulario_autor" name="formulario_autor" method="post" action="cadastro_autor.php" onsubmit="return valida_form_autores();">
                    <div class="row-fluid">
                        <div class="span5">
                            <label>Nome  </label>
                            <input type="text" class="input-block-level"  placeholder="Primeiro Nome..." id="nome_autor" name="nome_autor" >
                            <label>Sobrenome: </label>
                            <input type="text" class="input-block-level" placeholder="Sobrenome ..." id="sobrenome_autor" name="sobrenome_autor" s>
                        </div>
                      
                    </div>
                    <br>
                    <button id="cadastrar_autor" name="cadastrar_autor" class="btn btn-primary btn-large pull-left" >Cadastrar Autor</button>
...
?> 
<tr>
     <td><?php print $item['id_autor']?> </td>
     <td><?php print $item['autor_nome']?></td>
     <td><?php print $item['autor_sobrenome']?> </td>
     <td> 
            <a href="editar_autorC.php?id_autor=<?php print $item['id_autor']; ?>">[EDITAR]</a>
            <a href="cadastro_autor.php?id_autor=<?php print $item['id_autor']; ?>">[DELETAR]</a>
    </td>
