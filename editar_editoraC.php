...
if(!empty($_GET['id_editora'])){
    ...
    header('Location: cadastro_editorarC.php');
    exit();
}
...
<body>
    ...
    <section id="contact-page" class="container">
        <div class="row-fluid">
            <div class="span8">
                <h4>Formulario para edição de Editoras</h4>
                <div class="status alert alert-success" style="display: none"></div>
                    <div class="row-fluid">
                    <form id="formulario_editar_editora" name="formulario_editar_editora" method="post" action="editar_editora.php">
                    <div class="row-fluid">
                        <div class="span5">
                            <input type="hidden" name="id_editora" value=<?php print $info['id_editora'];?>>
                            <label>Nome  </label>
                            <input type="text" class="input-block-level"  placeholder="Nome Editora..." id="editora_nome" name="editora_nome" value=<?php print $info['editora_nome'];?>>
                            <label>Sobrenome: </label>
                            <input type="text" class="input-block-level" placeholder="CNPJ ..." id="cnpj" name="cnpj" value=<?php print $info['editora_cnpj'];?>>
                        </div>
                      
                    </div>
                    <br>
                    <button id="cadastrar_editora" name="cadastrar_editora" class="btn btn-primary btn-large pull-left" >Editar Editora</button>
